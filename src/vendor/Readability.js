...
// --- Article → Obsidian Saver 追記 ---
// chrome.scripting.executeScript の files 注入では各ファイルが独立スコープで
// 実行され、トップレベル関数宣言が自動で window に載らないため、明示公開する。
(typeof window !== "undefined" ? window : globalThis).Readability = Readability;
